    ...
    <div class="container-fluid py-4 px-3 px-lg-4 dashboard-page"
         x-data="{
            ...
            updateClock() {
                ...
                let hour = Number(hourParts.find(part => part.type === 'hour')?.value || 0);
                if (hour === 24) hour = 0;
            ...
            <div class="row align-items-center g-4">
                <div class="col-12 col-xl-8">
                    ...
                    <p class="text-secondary mb-0 dashboard-description">
                        Supervisa el microclima, las incubadoras, alertas, sensores y actuadores desde un solo panel.
                    </p>
                </div>
                    ...
                    <div class="card dashboard-panel h-100">
                        <div class="card-header dashboard-panel-header">
                            ...
                            <div class="d-flex gap-3 text-end">
                                <div>
                                    <span class="small text-secondary d-block">Lotes</span>
                                    <strong id="metricLotesTotal" class="text-brand-dark">{{ $lotesTotal }}</strong>
                                </div>

                                <div>
                                    <span class="small text-secondary d-block">Frascos</span>
                                    <strong id="metricFrascosTotal" class="text-brand-dark">{{ $frascosTotal }}</strong>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <article class="incubator-summary h-100">
                                            ...
                                            <div class="incubator-detail">
                                                <span>Estado</span>
                                                <strong>{{ $inc->estado->nombre ?? 'Sin estado' }}</strong>
                                            </div>
