@include('vistas_principales.shared.modulo-crud', [
    ...
    'fields' => [
        ['name'=>'seguimiento_lote_id','label'=>'Seguimiento del lote','type'=>'select','required'=>true,'options'=>$seguimientosOptions ?? [],'option_value'=>'id','option_label'=>'etiqueta'],
        ['name'=>'archivo','label'=>'Fotografía','type'=>'file','required'=>true,'accept'=>'image/jpeg,image/png,image/webp','help'=>'Formatos permitidos: JPG, PNG y WEBP. Máximo 5 MB.'],
