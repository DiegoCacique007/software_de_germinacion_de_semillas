...
<x-app-layout>
    <div class="container-fluid py-4 px-3 px-lg-4">
        <div class="mb-4">
            ...
            <p class="text-secondary mb-0">Panel de operación y seguimiento de incubadoras asignadas.</p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                        <h4 class="fw-bold mb-2" style="color:#1c607a;">Panel del Encargado</h4>
                        <p class="text-secondary mb-0">
                            Aquí se mostrarán las incubadoras asignadas, lecturas ambientales, lotes, frascos, seguimientos y alertas que correspondan al usuario.
                        </p>
                    </div>
                </div>
            </div>
